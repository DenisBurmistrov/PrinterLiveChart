...
public class Test extends Application {
    ...
    private void addDataToSeries() {
        for (int i = 0; i < 20; i++) { //-- add 20 numbers to the plot+
            ...
            series1.getData().add(new XYChart.Data<>((Number) xSeriesData++, dataQ1.remove()));
            series2.getData().add(new XYChart.Data<>((Number)xSeriesData++, dataQ2.remove()));
            series3.getData().add(new XYChart.Data<>((Number)xSeriesData++, dataQ3.remove()));
        }
